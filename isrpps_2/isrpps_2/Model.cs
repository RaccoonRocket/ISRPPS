...
namespace isrpps_2
{
    ...
    {
        public readonly int V = 6; // Number of vertices in
                                          // graph
        ...
        public int driverCode(int start, int end, int[,] graph)
        {
            MaxFlow m = new MaxFlow();
            return m.fordFulkerson(graph, start, end);
        }
    }

    public class Delegator
    {
        public MaxFlow m = new MaxFlow();

        public int MaxFlow(int start, int end, int[,] graph)
        {
            return m.driverCode(start, end, graph);
        }
    }
}
